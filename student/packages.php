...
<body>
    ...
    <div class="pricing-container">
        ...
        <div class="package-card">
            ...
            <a href="dashboard.php#contact" class="btn-package btn-starter">Choose Starter</a>
        </div>
        ...
        <div class="package-card featured">
            ...
            <a href="dashboard.php#contact" class="btn-package btn-featured">Choose Adventure</a>
        </div>
        ...
        <div class="package-card">
            ...
            <a href="dashboard.php#contact" class="btn-package btn-luxury">Choose Luxury</a>
        </div>
