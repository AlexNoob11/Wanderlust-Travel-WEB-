...
$userName = $isLoggedIn ? $_SESSION['user_name'] : "Traveler";
$userId = $isLoggedIn ? $_SESSION['user_id'] : null;

// If this is strictly a student dashboard, uncomment the lines below to force login:
/*
if (!$isLoggedIn) {
...
<body>
        ...
        <div class="grid">
            <div class="card">
                ...
                <div class="card-info">
                    ...
                    <a href="view-details.php?location=italy&uid=<?php echo $userId; ?>" class="detail-link">View Details →</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-info">
                    ...
                    <a href="view-details.php?location=usa&uid=<?php echo $userId; ?>" class="detail-link">View Details →</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-info">
                    ...
                    <a href="view-details.php?location=japan&uid=<?php echo $userId; ?>" class="detail-link">View Details →</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-info">
                    ...
                    <a href="view-details.php?location=greece&uid=<?php echo $userId; ?>" class="detail-link">View Details →</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-info">
                    ...
                    <a href="view-details.php?location=bali&uid=<?php echo $userId; ?>" class="detail-link">View Details →</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-info">
                    ...
                    <a href="view-details.php?location=iceland&uid=<?php echo $userId; ?>" class="detail-link">View Details →</a>
                </div>
            </div>
        </div>
        
        <div class="view-all-container" style="text-align: center; margin-top: 40px;">
            <a href="all-destinations.php?uid=<?php echo $userId; ?>" class="btn-outline">View All Destinations</a>
        </div>
    </section>
    ...
    <section id="packages" class="section bg-light">
        ...
        <div class="package-container">
            <div class="p-card">
                ...
                <a href="book.php?p=starter&uid=<?php echo $userId; ?>" class="btn-outline">Book Starter</a>
            </div>
            <div class="p-card featured">
                ...
                <a href="book.php?p=adventure&uid=<?php echo $userId; ?>" class="btn-primary">Book Adventure</a>
            </div>
            <div class="p-card">
                <h3>Luxury</h3>
                ...
                <a href="book.php?p=luxury&uid=<?php echo $userId; ?>" class="btn-outline">Book Luxury</a>
            </div>
        </div>
    </section>
        ...
        <form class="contact-form" action="process_inquiry.php" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                <input type="text" name="name" placeholder="Full Name" 
                       value="<?php echo $isLoggedIn ? htmlspecialchars($userName) : ''; ?>" required>
    ...
    <script>
        ...
        if (status === 'success') {
            ...
            Swal.fire({
                title: 'Welcome Back!',
                text: 'Good to see you again, <?php echo addslashes($userName); ?>!',
                icon: 'success'
            });
        ...
        // Modal Logic (Check if elements exist before assigning)
